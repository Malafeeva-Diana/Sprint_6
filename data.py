class TestData:
    test_data_user1 = ['Иван', 'Васильевич', 'Новокузнецкая, 13', 'Новокузнецкая', '+79013834215', '15.06.2024',
                       'Меняю профессию на самокат']

    test_data_user2 = ['Шрек', 'Огр', 'Сказочное болото', 'Сокол', '+788811199922', '14.06.2024',
                       'Еду к фионе']
